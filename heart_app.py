...
heart_attack = row4_1.selectbox("Have you ever been diagnosed with a heart attack?", ["yes", "no"], help="A heart attack occurs when blood flow to part of the heart is blocked!", index=1)
...
stroke = row4_2.selectbox("Have you ever been diagnosed with a stroke?", ["yes", "no"], help="A stroke happens when blood supply to part of the brain is interrupted!", index=1)
diabetes = row4_2.selectbox("Have you ever been diagnosed with diabetes?", ["yes", "no", "no_prediabetes", "yes_during_pregnancy"], key="diabetes", index=1)
...
], help="BMI is a measure of body fat based on height and weight. Please use the BMI calculator at https://www.nhlbi.nih.gov/health/educational/lose_wt/BMI/bmicalc.htm", index=1)
...
depressive_disorder = row4_3.selectbox("Has a doctor ever told you that you have a depressive disorder?", ["yes", "no"], help="A depressive disorder is a medical condition characterized by persistent feelings of sadness, loss of interest, and other emotional and physical symptoms!", index=1)
physical_health = row4_3.selectbox("How many days in the past 30 days was your physical health not good?", ["zero_days_not_good", "1_to_13_days_not_good", "14_plus_days_not_good"], key="physical_health", index=0)
mental_health = row4_3.selectbox("How many days in the past 30 days was your mental health not good?", ["zero_days_not_good", "1_to_13_days_not_good", "14_plus_days_not_good"], key="mental_health", index=0)
walking = row4_3.selectbox("Do you have difficulty walking or climbing stairs?", ["yes", "no"], key="walking", index=1)
...
smoking_status = row6_1.selectbox("What is your smoking status?", [
    "never_smoked", "former_smoker", "current_smoker_some_days", "current_smoker_every_day"], key="smoking_status", index=0)
sleep_category = row6_1.selectbox("How many hours of sleep do you get on a typical night?", [
    ...
    "long_sleep_9_to_10_hours", "very_long_sleep_11_or_more_hours"], key="sleep_category", index=2)
drinks_category = row6_2.selectbox("How many alcoholic drinks do you consume in a typical week?", [
    ...
    "moderate_consumption_5.01_to_10_drinks", "high_consumption_10.01_to_20_drinks", "very_high_consumption_more_than_20_drinks"], key="drinks_category", index=0)
binge_drinking_status = row6_2.selectbox("Have you engaged in binge drinking in the past 30 days?", ["yes", "no"], help="Binge drinking is consuming 5 or more drinks for men, or 4 or more drinks for women, in about 2 hours!", index=1)
...
st.write('---')   
#row8_0, row8_1,row8_2 ,row8_5= st.columns((0.08,6,6,0.17))
...
if btn1:
    try:
        ...
        with row8_1: 
            ...
            # Normalize SHAP values to sum to 100%
            ...
            #st.write("Feature Contributions to the Risk Assessment:")
            #st.write(feature_importance_df)
            
            # Plot feature importance
            #st.bar_chart(feature_importance_df.set_index('Feature'))
            #fig = px.bar(feature_importance_df, x='Importance', y='Feature', orientation='h',
            #title='Feature Importances from EasyEnsembleClassifier',
           ...
           # Provide recommendations based on risk and user inputs
            ...
            # Only proceed with recommendations if the risk is moderate, high, or very high
            if risk > 25:
                # Determine which features contribute to 50% of the risk
                ...
                # Sort important features by their importance in descending order
                ...
                # Provide recommendations based on the most important features
       ...
       # with row8_2: 
           ...
           # st.write(
                 #   """
#
 #                   #### **Feature Contributions to the Risk Assessment**
  #                  """)
